...
export default function NordpoolTodayChartCard() {
  ...
  const currentY = CHART_PADDING_TOP + innerHeight - ((currentPoint.price - minValue) / range) * innerHeight;
          ...
          <div className="relative rounded-3xl bg-[linear-gradient(180deg,rgba(0,67,66,0.08),rgba(0,67,66,0.02))] p-4 sm:p-5">
            <div className="-mx-1 overflow-x-auto px-1 pb-2 sm:mx-0 sm:px-0">
              <svg
                ...
                className="h-auto min-w-[44rem] aspect-[4/1] w-[44rem] sm:min-w-0 sm:w-full"
                role="img"
