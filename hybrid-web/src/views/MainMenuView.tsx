        ...
        <>
            ...
            <main className="mx-auto max-w-7xl px-6 pb-32 pt-16">
                <section className="mb-12">
                    <div className="grid grid-cols-1 gap-8 items-end lg:grid-cols-12">
                        ...
                        <div className="lg:col-span-5">
                            <div
                                className="signature-gradient group relative overflow-hidden rounded-xl p-8 text-on-primary shadow-2xl transition-transform duration-300 hover:-translate-y-1 hover:shadow-[0_24px_48px_rgba(0,67,66,0.24)]">
                                <div
                                    className="absolute -right-10 -top-10 h-40 w-40 rounded-full bg-secondary-container opacity-10 blur-3xl transition-transform duration-500 group-hover:scale-125"/>
                                <div className="mb-10 flex items-start justify-between">
                                    <div>
                                        <p className="mb-1 text-sm font-semibold uppercase tracking-wider text-primary-fixed">Total
                                            Consumption</p>
                                        <div className="flex items-baseline gap-2">
                                            <span
                                                className="font-headline text-5xl font-extrabold">{consumptionLabel}</span>
                                            <span className="text-xl font-medium opacity-80">kW</span>
                                        </div>
                                    </div>
                                    <span
                                        className="font-headline text-4xl font-black text-secondary-container">⚡</span>
                                </div>
                                <div className="space-y-4">
                                    ...
                                    {statsError ?
                                        <p className="text-xs text-primary-fixed">Stats sync unavailable.</p> : null}
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            >
                                ...
                                <div className="flex h-full flex-col justify-between gap-12">
                                    <div className="flex items-start justify-between">
                                        <div
                                            className="rounded-lg bg-white p-3 shadow-sm transition-all duration-300 group-hover:-translate-y-0.5 group-hover:scale-110 group-hover:shadow-md">
                                            <span
                                                className="font-headline text-xl font-black text-primary">{tile.icon}</span>
                                        </div>
                                        <span
                                            className="translate-y-1 text-lg text-outline-variant opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:text-primary group-hover:opacity-100">↗</span>
                                    </div>
                                    <div>
