...
public interface BillingSubscriptionRepository extends JpaRepository<BillingSubscriptionEntity, Long> {
    ...
    Optional<BillingSubscriptionEntity> findByProviderAndPurchaseToken(BillingProvider provider, String purchaseToken);

    List<BillingSubscriptionEntity> findByAccountIdAndStatusOrderByUpdatedAtDesc(
            Long accountId,
