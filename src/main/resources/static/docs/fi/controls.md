...
Porssiohjainin ohjauksilla ohjataan tavallisten laitekanavien kytkentää sähkön hinnan perusteella sekä lämpöpumppujen tilamuutoksia ajastetusti.

## Mitä ohjaus tekee

Ohjaus muodostaa automaattisen aikataulun Nord Poolin hintojen perusteella. Ohjaukseen liitetyt laitteet seuraavat tätä aikataulua, ellei jokin korkeampiprioriteettinen sääntö ohita sitä.
...
- `Aina päällä kun alle minimihinnan`: Halvimmat tunnit -tilassa kaikki minimihinnan alittavat tai siihen osuvat jaksot valitaan ensin.
...
- Jos `Aina päällä kun alle minimihinnan` on käytössä, kaikki `Minimihinnan` alittavat tai siihen osuvat jaksot otetaan ensin.
...
Ohjaus ohittaa hintapohjaisen aikataulun ja pitää liitetyt kanavat päällä tai pois päältä `Manuaalinen päällä` -valinnan mukaan.
...
Ohjausten aikataulut päivitetään automaattisesti seuraavan päivän Nord Pool -tuonnin jälkeen. Nykyisessä sovelluksessa tämä tapahtuu päivittäisissä ajastetuissa ajoissa uuden hintadatan latauksen jälkeen.
