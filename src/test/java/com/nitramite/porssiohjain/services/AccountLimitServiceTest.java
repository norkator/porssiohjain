...
class AccountLimitServiceTest {
    ...
    @Test
    void freeTierAllowsThreeNotificationsPerWeek() {
        ...
        assertTrue(accountLimitService.tryConsumeWeeklyNotification(1L, first));
        assertTrue(accountLimitService.tryConsumeWeeklyNotification(1L, first.plusSeconds(60)));
        assertTrue(accountLimitService.tryConsumeWeeklyNotification(1L, first.plusSeconds(120)));
        assertFalse(accountLimitService.tryConsumeWeeklyNotification(1L, first.plusSeconds(180)));
    ...
    void newWeekResetsNotificationCounter() {
        ...
        assertTrue(accountLimitService.tryConsumeWeeklyNotification(1L, Instant.parse("2026-04-27T00:00:00Z")));
    ...
    void paidTierUsesHigherWeeklyLimit() {
        ...
        assertTrue(accountLimitService.tryConsumeWeeklyNotification(1L, Instant.parse("2026-04-27T08:00:00Z")));
        assertFalse(accountLimitService.tryConsumeWeeklyNotification(1L, Instant.parse("2026-04-27T08:01:00Z")));
        assertEquals(100, accountLimitService.getEffectiveWeeklyNotificationLimit(1L));
    }
